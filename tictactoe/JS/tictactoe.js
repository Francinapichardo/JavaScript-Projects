...
function placeXOrO(squareNumber) {
    //This condition ensures a square hasn't beem selected already.
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if(activePlayer === 'X') {
            ...
            //If activePlayer is equal to 'O', theo.png os places in HTML
            select.style.backgroundImage = 'url("images/o.png")';
    }
    //squareNumber and activePlayer are concatenated torgether and added to array.
    ...
    //This function results in a random square being selencted by the computer.
    function computersTurn() {
        //This boolean is needed fot our while loop.
        let success = false;
        //Thid variable stores random number 0-8.
        let pickASquare;
